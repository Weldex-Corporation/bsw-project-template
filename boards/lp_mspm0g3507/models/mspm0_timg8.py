# MSPM0G3507 TIMG8 model for Renode SIL  (IRQ 2)
#
# TIMG8 base: 0x40090000, size: 0x2000
#
# Register offsets:
...
#   -> fires NVIC IRQ 2 with IIDX=ZERO_EVENT each period
...
def start_lt():
    ...
    try:
        ...
        lt = LimitTimer(machine.ClockSource, long(irq_hz), self, "timg8_lt")
        lt.Limit = long(1)
        lt.AutoUpdate = True
